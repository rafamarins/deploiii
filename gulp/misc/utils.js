...
module.exports = function () {
  this.run_sass_autoprefixer = function (
    src,
    destination,
    autoprefixerConfig,
    cssnanoConfig
    ...
    this.pump([
      ...
      this.gulpif(
        this.config.app.input.compiler.styles.sass === true,
        ...
        this.gulpif(
          this.config.app.input.compiler.styles.less === true,
  ...
  this.run_uglify = function (src, destination) {
    this.pump([
      ...
      this.gulp.dest(destination),
      this.gulpif(
        this.config.app.output.uglify === true,
  ...
  function filepathExists (path) {
    if (this.fs.existsSync(path)) {
      ...
      this.gutil.log(
        this.gutil.colors.red('[Error]'),
        "File doesn't exists, please verify your paths & files -> " + path
      )
      return false
    }
  }
